...
def PintarPreenchimento(event):
    ...
    if cor:
        ...
        indicador_preenchimento.configure(bg=cor)


def reset_color(event):
    global cor_preenchimento
    cor_preenchimento = ""
    indicador_preenchimento.configure(bg="white")
...
indicador_preenchimento = Label(frame,bg="white",width=3,height=1,relief="sunken",bd=1)
