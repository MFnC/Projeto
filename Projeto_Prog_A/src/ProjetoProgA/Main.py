...
from Modelo.Figura.Subclasses_FigurasDoisPontos.Linha import Linha
from Modelo.Figura.Subclasses_FigurasDoisPontos.Oval import Oval
from Modelo.Figura.Subclasses_FigurasDoisPontos.Retangulo import Retangulo
from Modelo.Figura.Subclasses_FigurasDoisPontos.Triangulo import Triangulo
from Modelo.Figura.Subclasses_FigurasDoisPontos.Pentagono import Pentagono
from Modelo.Figura.Subclasses_FigurasDoisPontos.Hexagono import Hexagono
...
def incluir_figura_nova(event):
    ...
    if not figura_nova.incompleta():
        desenho.adicionar(figura_nova)
    desenhar_figuras()

def desenhar_figuras():
    canvas.delete("all")
    for figura in desenho.obter_figuras():
...
from Modelo.Figura.Desenho import Desenho
desenho = Desenho()
figura_nova = None
