...
cor_borda = "#000000"
cor_preenchimento = ""  # Iniciando vazio (sem preenchimento)
...
def PintarPreenchimento(event):
    ...
    # Se estiver vazio, abre o seletor sugerindo branco por padrão
...
def reset_color(event):
    global cor_preenchimento
    cor_preenchimento = ""  # Reseta para transparente
    
    # Camufla o indicador adotando a cor atual do canvas background
...
def alternar_tema():
    if canvas.cget('bg') == '#ffffff':
        ...
        # Se estiver sem preenchimento, camufla com a cor do canvas escuro
